...
export function DirectionLockView(props) {
    ...
    return (React.createElement("div", { className: "lock" },
        React.createElement("div", { className: "txt" },
            ...
            React.createElement("p", null, "Start by finding the asteroid belt in the night sky. Then try to find Earth. You also see saturn Saturn, which right now is very close to Jupiter. You just want to get back to the blue planet.")),
